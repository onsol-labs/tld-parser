import { APTOS_TESTNET_SUZUKA_NODE_URL, TldParser } from '../src';
import { AptosSettings, Network } from '@aptos-labs/ts-sdk';

const owner =
    '0x21e19c21e71a23e4f407a1a6067e46ce18ed5295df146515ba58f62d8cd2a425';

describe('tldParser MOVE tests', () => {
    it('should perform fetching of all user domains', async () => {
        
        const aptosSettings: AptosSettings = {
            fullnode: APTOS_TESTNET_SUZUKA_NODE_URL,
            indexer: "https://indexer.testnet.suzuka.movementlabs.xyz/console/api/api-explorer"
        };
