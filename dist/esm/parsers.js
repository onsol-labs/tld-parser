...
import { findMainDomain, findOwnedNameAccountsForUser, findTldHouse, getHashedName, getNameAccountKeyWithBump, getNameOwner, getOriginNameAccountKey, } from './utils';
export class TldParser {
    ...
    getAllUserDomainsFromTld(userAccount, tld) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parentHashedName = yield getHashedName(tldName);
    ...
    getOwnerFromDomainTld(domainTld) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parentHashedName = yield getHashedName(tldName);
            const [parentAccountKey] = getNameAccountKeyWithBump(parentHashedName, undefined, nameOriginTldKey);
            const domainHashedName = yield getHashedName(domain);
            ...
            const nameOwner = yield getNameOwner(this.connection, domainAccountKey, tldHouse);
            return nameOwner;
        });
    }
    /**
